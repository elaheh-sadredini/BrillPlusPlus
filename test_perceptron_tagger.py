# Test the Perceptron PoS Tagger in NLTK
# Elaheh Sadredini and Deyuan Guo, Feb 09, 2018
...
# Test the Perceptron PoS tagger with 5-fold CV
...
if __name__ == '__main__':
    print 'Testing the Perceptron PoS Tagger in NLTK.'
    help_msg = 'Usage: test_perceptron_tagger.py <treebank|brown>'
